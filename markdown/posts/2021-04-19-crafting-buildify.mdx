...
I recently distanced myself a bit from [Tuist](https://tuist.io). The project is moving forward in the right direction and doesn't require much of my involvement. That gave me the mental space and time to explore a new open-source idea, [**Buildify**](https://github.com/buildifydev/buildify).
